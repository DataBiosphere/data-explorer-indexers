...
def prepare_cluster(config, runtime):
  ...
  docker_util.format_all_in_one_yaml("docker.elastic.co/eck/eck-operator:1.1.2", config)
  ...
  docker_util.prepare_image("docker.elastic.co/elasticsearch/elasticsearch:7.7.1", config)
