...
#
#   curl -XDELETE localhost:9200/framingham_heart_study_teaching && curl -XDELETE localhost:9200/framingham_heart_study_teaching_fields
#   DATASET_CONFIG_DIR=dataset_config/framingham_heart_study_teaching docker-compose up --build indexer
#   curl -s 'http://localhost:9200/framingham_heart_study_teaching/type/9334261' | jq -rS '._source' > 'tests/framingham_heart_study_teaching_golden.json'
#   curl -s 'http://localhost:9200/framingham_heart_study_teaching/_mappings?pretty' | jq -rS '.' > 'tests/framingham_heart_study_teaching_mappings_golden.json'
#   curl -s 'http://localhost:9200/framingham_heart_study_teaching_fields/_search?size=200' | jq -rS '.hits.hits' > 'tests/framingham_heart_study_teaching_fields_golden.json'
...
curl -XDELETE localhost:9200/framingham_heart_study_teaching
curl -XDELETE localhost:9200/framingham_heart_study_teaching_fields
...
DOC_COUNT_FRAMINGHAM=$(curl -s 'http://localhost:9200/framingham_heart_study_teaching/_search' | jq -r '.hits.total')
...
curl -s 'http://localhost:9200/framingham_heart_study_teaching/type/9334261' | jq -rS '._source' > 'tests/framingham_heart_study_teaching.json'
DIFF=$(diff tests/framingham_heart_study_teaching_golden.json tests/framingham_heart_study_teaching.json)
if [ "$DIFF" != "" ]; then
  echo "Index does not match golden json file, diff:"
  echo "$DIFF"
  exit 1
...
curl -s 'http://localhost:9200/framingham_heart_study_teaching/_mappings?pretty' | jq -rS '.' > 'tests/framingham_heart_study_teaching_mappings.json'
DIFF=$(diff tests/framingham_heart_study_teaching_mappings_golden.json tests/framingham_heart_study_teaching_mappings.json)
if [ "$DIFF" != "" ]; then
  echo "Mappings do not match golden json file, diff:"
  echo "$DIFF"
  exit 1
...
curl -s 'http://localhost:9200/framingham_heart_study_teaching_fields/_search?size=200' | jq -rS '.hits.hits' > 'tests/framingham_heart_study_teaching_fields.json'
DIFF=$(diff tests/framingham_heart_study_teaching_fields_golden.json tests/framingham_heart_study_teaching_fields.json)
if [ "$DIFF" != "" ]; then
  echo "Fields index does not match golden json file, diff:"
  echo "$DIFF"
  exit 1
...
rm tests/framingham_heart_study_teaching.json
rm tests/framingham_heart_study_teaching_mappings.json
rm tests/framingham_heart_study_teaching_fields.json
docker-compose stop
