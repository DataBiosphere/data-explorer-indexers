...
* If you want to use your own dataset:
  * For each dataset, there is a directory in `dataset_config`, e.g.
  `dataset_config/amp_pd`. Create a directory for your dataset. Copy
  `dataset_config/template/*` to this directory.
